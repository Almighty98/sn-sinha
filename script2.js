...
document.getElementById('emi').innerText = ((parseFloat(localStorage.getItem('loan'))+parseFloat(localStorage.getItem('interest')))/35).toFixed(2);
...
document.getElementById('total').innerText = (parseFloat(document.getElementById('margin').innerText)+
                                            ...
                                            parseFloat(document.getElementById('ad_emi').innerText)).toFixed(2).toString()+' ₹';
document.getElementById('rs_total').innerText = (parseFloat(document.getElementById('total').innerText)-parseFloat(localStorage.getItem('rc'))).toFixed(2).toString() + ' ₹';
document.getElementById('down_pmt').innerText = (parseFloat(document.getElementById('rs_total').innerText)-parseFloat(document.getElementById('discount').innerText)).toFixed(2).toString()+' ₹';
