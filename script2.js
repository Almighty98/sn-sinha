...
document.getElementById('rs_total').innerText = (parseFloat(document.getElementById('total').innerText)-parseFloat(localStorage.getItem('old_rc'))-parseFloat(localStorage.getItem('driver_rc'))).toFixed(2).toString() + ' ₹';
