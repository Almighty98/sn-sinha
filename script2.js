...
document.getElementById('processing').innerText = localStorage.getItem('processing')+'%';
...
document.getElementById('rc').innerText = localStorage.getItem('rc');
...
document.getElementById('total_interest').innerText = parseFloat(localStorage.getItem('loan'))*(parseFloat(localStorage.getItem('interest'))/100)*parseFloat(localStorage.getItem('tenure'));
document.getElementById('emi').innerText = (parseFloat(localStorage.getItem('loan'))+parseFloat(localStorage.getItem('interest')))/35;
...
document.getElementById('ad_emi').innerText = document.getElementById('emi').innerText;
document.getElementById('total').innerText = parseFloat(document.getElementById('margin').innerText)+
                                            ...
                                            parseFloat(document.getElementById('ad_emi').innerText);
document.getElementById('rs_total').innerText = parseFloat(document.getElementById('total').innerText)-parseFloat(localStorage.getItem('rc'));
document.getElementById('down_pmt').innerText = parseFloat(document.getElementById('rs_total').innerText)-parseFloat(document.getElementById('discount').innerText);
...
document.getElementById('download').onclick = function(){
    ...
    const invoice = document.body.removeChild(download);
    html2pdf(invoice).save();
}