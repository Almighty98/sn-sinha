...
document.getElementById('rs_total').innerText += (parseFloat(document.getElementById('total').innerText.split("₹ ")[1])-parseFloat(localStorage.getItem('old_rc'))-parseFloat(localStorage.getItem('driver_rc'))).toFixed(2);
document.getElementById('down_pmt').innerText += (parseFloat(document.getElementById('rs_total').innerText.split("₹ ")[1])-parseFloat(document.getElementById('discount').innerText)).toFixed(2);
document.getElementById("division").innerText = (parseFloat(document.getElementById('loan_amt').innerText)*100/parseFloat(document.getElementById('actual').innerText)).toFixed(2).toString() + ' %'
